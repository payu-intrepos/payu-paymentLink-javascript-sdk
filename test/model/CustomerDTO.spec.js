...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HubToken.CustomerDTO();
  });
  ...
  describe('CustomerDTO', function() {
    it('should create an instance of CustomerDTO', function() {
      ...
      //var instane = new HubToken.CustomerDTO();
      //expect(instance).to.be.a(HubToken.CustomerDTO);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new HubToken.CustomerDTO();
